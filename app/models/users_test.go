...
var (
	userDBTypes = map[string]string{`ID`: `integer`, `UUID`: `character varying`, `Name`: `character varying`, `Email`: `character varying`, `PasswordDigest`: `character varying`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`}
	_           = bytes.MinRead
)
