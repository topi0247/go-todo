...
var UserTableColumns = struct {
	...
	Name:           "users.name",
	Email:          "users.email",
	PasswordDigest: "users.password_digest",
...
var UserWhere = struct {
	...
	PasswordDigest: whereHelperstring{field: "\"users\".\"password_digest\""},
...
var (
	userAllColumns            = []string{"id", "uuid", "name", "email", "password_digest", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"uuid", "name", "email", "password_digest"}
