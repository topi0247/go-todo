...
var (
	todoDBTypes = map[string]string{`ID`: `integer`, `Title`: `text`, `Description`: `text`, `Completed`: `boolean`, `CreatedAt`: `timestamp without time zone`, `UpdatedAt`: `timestamp without time zone`, `UserID`: `integer`}
	_           = bytes.MinRead
)
